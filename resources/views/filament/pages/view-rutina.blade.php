<x-filament-panels::page>
    ...
    <x-filament-panels::header
        ...
        :subheading="'Atleta: ' . $rutina->atleta->user->name"
    />
    ...
    <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    <div class="flex items-center gap-3 mb-2">
                        ...
                        <span class="text-sm font-semibold text-gray-600">VERSIÓN</span>
                    </div>
                    <p class="text-lg font-medium text-gray-800">v{{ $rutina->version }}</p>
                </div>
            </div>
        </div>
                                ...
                                @foreach($dia->ejerciciosDia->sortBy('orden') as $ejercicioDia)
                                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-5">
                                        ...
                                        <div class="flex items-start justify-between mb-4">
                                            ...
                                            <span class="bg-blue-100 text-blue-800 text-sm font-medium px-2 py-1 rounded ml-4">
                                            ...
                                            <table class="w-full text-sm">
                                                <thead>
                                                    <tr class="bg-gray-100">
                                                        ...
                                                        <th class="px-3 py-2 text-left font-semibold text-gray-700">Repeticiones</th>
                                                        <th class="px-3 py-2 text-left font-semibold text-gray-700">Peso</th>
                                                        <th class="px-3 py-2 text-left font-semibold text-gray-700">Descanso</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
        ...
        <!-- Si no hay semanas -->
        @if($rutina->semanasRutina->isEmpty())
